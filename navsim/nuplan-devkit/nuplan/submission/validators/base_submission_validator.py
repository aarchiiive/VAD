...
class BaseSubmissionValidator(AbstractSubmissionValidator):
    ...
    def __init__(self) -> None:
        ...
        self._next_validator: Optional[AbstractSubmissionValidator] = None
        self._failing_validator: Optional[Type[AbstractSubmissionValidator]] = None
    ...
    @property
    def failing_validator(self) -> Optional[Type[AbstractSubmissionValidator]]:
        """
